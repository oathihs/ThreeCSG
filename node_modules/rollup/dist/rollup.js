/*
	Rollup.js v0.26.3
	Wed May 11 2016 13:43:52 GMT-0400 (EDT) - commit 8ee6ef01090a8def1d143f7c56829d367b7ee160
	...
	if ( source ) {
		...
		if ( node.type === 'ExportAllDeclaration' ) {
			...
			node.specifiers.forEach( function ( specifier ) {
				this$1.reexports[ specifier.exported.name ] = {
...
function cjs ( bundle, magicString, ref, options ) {
	...
	var hasDefaultImport = bundle.externalModules.some( function ( mod ) { return mod.declarations.default; });
	...
	var exportBlock = getExportBlock( bundle.entryModule, ref.exportMode, 'module.exports =' );
	if ( exportBlock ) magicString.append( '\n\n' + exportBlock );
...
function resolveId ( importee, importer ) {
	...
	if ( importer === undefined ) return addJsExtensionIfNecessary( resolve$2( process.cwd(), importee ) );

	// external modules are skipped at this stage
	if ( importee[0] !== '.' ) return null;

	return addJsExtensionIfNecessary( resolve$2( dirname( importer ), importee ) );
}
...
var Bundle = function Bundle ( options ) {
	...
	this.resolveId = first(
		[ function ( id ) { return ~this$1.external.indexOf( id ) ? false : null; } ]
	...
	this.external = ensureArray( options.external ).map( function ( id ) { return id.replace( /[\/\\]/g, '/' ); } );
		...
		return this$1.resolveId( source, module.id )
			.then( function ( resolvedId ) {
				...
				if ( resolvedId ) {
					...
					externalName = resolve$2( module.id, '..', source );
				}
				var forcedExternal = externalName && ~this$1.external.indexOf( externalName );
				...
				if ( !resolvedId || forcedExternal ) {
					...
					if ( !forcedExternal ) {
						...
						if ( !~this$1.external.indexOf( source ) ) this$1.onwarn( ("Treating '" + source + "' as external dependency") );
					} else if ( resolvedId ) {
...
Bundle.prototype.render = function render ( options ) {
	...
	if ( options.sourceMap ) {
		...
		if ( file ) file = resolve$2( typeof process !== 'undefined' ? process.cwd() : '', file );
